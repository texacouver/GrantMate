...
import { insertGrantProposalSchema, type InsertGrantProposal } from "@shared/schema";
...
export function GrantForm({ data, onChange, onGenerate, isGenerating, setIsGenerating }: GrantFormProps) {
  ...
  const handleSubmit = async (formData: InsertGrantProposal) => {
    try {
      ...
      const generateResponse = await apiRequest("POST", "/api/generate-proposal", formData);
  ...
  return (
    <Card className="p-8 glass-card border-minimal rounded-medium">
          ...
          <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-12">
            ...
            <div className="space-y-6">
              <div className="pb-4">
                ...
                <p className="text-muted-foreground mt-2 text-sm">Basic details about your organization</p>
              </div>
            ...
            <div className="space-y-6">
              <div className="pb-4">
                ...
                <p className="text-muted-foreground mt-2 text-sm">Your organization's core purpose and values</p>
              </div>
            ...
            <div className="space-y-6">
              <div className="pb-4">
                ...
                <p className="text-muted-foreground mt-2 text-sm">Comprehensive project information</p>
              </div>
            ...
            <div className="space-y-6">
              <div className="pb-4">
                ...
                <p className="text-muted-foreground mt-2 text-sm">Expected results and measurable outcomes</p>
              </div>
            ...
            <div className="pt-8">
              <Button
                ...
                className="w-full bg-foreground hover:bg-foreground/90 text-background py-4 px-6 text-base font-medium button-shadow transition-all duration-150 disabled:opacity-50 hover-button"
              >
                {isGenerating ? (
                  <>
